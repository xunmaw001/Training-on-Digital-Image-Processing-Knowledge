<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="所属专业" prop="suoshuzhuanye">
          <el-select v-model="ruleForm.suoshuzhuanye" placeholder="请选择所属专业">
            <el-option
                v-for="(item,index) in suoshuzhuanyeOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="所属专业" prop="suoshuzhuanye">
	      <el-input v-model="ruleForm.suoshuzhuanye"
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='suoshuzhuanye'){
            this.ruleForm.suoshuzhuanye = obj[o];
	    this.ro.suoshuzhuanye = true;
            continue;
          }
	            	            if(o=='banjimingcheng'){
